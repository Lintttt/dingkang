  ...
  <table class='table table-form table-fixed'> 
    <thead>
      <tr>
        ...
        <th class='w-120px'><?php echo $lang->user->leader;?></th>
    ...
    <?php $leaderList = $leaderList + array('ditto' => $lang->user->ditto)?>
    ...
    <tr class='text-center'>
      ...
      <td class='text-left' style='overflow:visible'><?php echo html::select("leader[$i]", $leaderList, $i > 0 ? 'ditto' : '', "class='form-control chosen'");?></td>
