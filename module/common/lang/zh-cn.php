 ...
 */
$lang->uploadDir    = 'www/data/upload/';
$lang->downloadDir  = 'www/data/download/';
...
$lang->menu->pm = '项目|pm|index';
$lang->menu->market = '市场|market|index';
$lang->menu->trial = '实验|trial|index';
$lang->menu->technology = '技术|technology|index';
$lang->menu->support = '支撑|support|index';
...
$lang->market->menu->list        = array('link' => '市场' . $lang->arrow , 'fixed' => true);
$lang->market->menu->index       ='我的客户|market|index';

//项目菜单设置
$lang->pm = new stdclass();
$lang->pm->menu = new stdclass();

$lang->pm->menu->list        = array('link' => '项目' . $lang->arrow , 'fixed' => true);
...
//样品菜单设置
$lang->trial = new stdclass();
$lang->trial->menu = new stdclass();
$lang->pm->menu->list        = array('link' => '项目' . $lang->arrow , 'fixed' => true);

$lang->trial->menu->list        = array('link' => '样品' . $lang->arrow , 'fixed' => true);
$lang->trial->menu->index       ='我的样品|trial|index';
